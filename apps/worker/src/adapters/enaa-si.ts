...
const manifest: SourceManifest = {
  ...
  termsUrl: new URL("https://www.enaa.com/splosni-pogoji"),
  policyStatus: "conditional",
  policyReviewedAt: "2026-07-26T12:18:00.000Z",
  policyReviewExpiresAt: "2026-08-25T12:18:00.000Z",
  policyNotes:
    "robots.txt advertises /sitemap and blocks /search, /api and account/cart paths. Production activation still requires owner/legal approval.",
